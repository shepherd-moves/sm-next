    ...
    <div className="bg-white pt-4 sm:pt-10 lg:pt-12">
      <footer className="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-b gap-4 py-6">
          <nav className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 md:gap-6">
            <a
              href="#"
        ...
        <div className="text-gray-400 text-sm flex-col py-8">
          <div className="text-center">
            © 2022 - Shephed Moves. All rights reserved.
          </div>
          <div className="text-center">
