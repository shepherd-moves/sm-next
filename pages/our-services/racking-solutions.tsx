...
function Racking() {
  ...
  return (
    <>
      <Head>
        <title>Racking Solutions</title>
        <meta property="og:title" content="Racking Solutions" />
        <meta
          name="description"
          content="Maximize your storage space with Shepherd Moves' Racking Solutions. Customized, scalable shelving systems designed for efficiency. Schedule a consultation for your warehouse needs."
        />
      </Head>
        ...
        <div className="flex flex-col gap-10 lg:flex-row justify-between ">
          <div className="w-full lg:w-8/12 ">
            <ReactCompareSlider
              ...
              itemTwo={
                <ReactCompareSliderImage src="/wh-after.jpeg" alt="two" />
              }
              style={{
                display: "flex",
                width: "100%",
          ...
          <div className="w-full lg:w-8/12 flex flex-col ">
            ...
            <p className="font-normal text-base leading-6 text-black ">
              Our team can install all types of racking for any storage
              purposes. With our tenure in the logistics and storage space, we
              also offer advise on what the best options for your storage needs
              are, and can provide and install racking to your specifications.
              For more information please don’t hesitate to contact one of our
              amazing staff to help you with your next office move.
            </p>
